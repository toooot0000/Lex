...
#undef YYCASE_
  ...
  "\"For\"", "\"In\"", "\"FROM\"", "\"identifier\"", "\"integer\"",
  "\"string\"", "$accept", "stmt", "expr", "literal", YY_NULLPTR
  };
#endif
