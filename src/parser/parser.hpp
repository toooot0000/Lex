...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_INTEGER = 277,             // "integer"
    TOK_STRING = 278               // "string"
      };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_DQUOTE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_DQUOTE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_QUATE (location_type l)
      {
        return symbol_type (token::TOK_QUATE, std::move (l));
      }
#else
      static
      symbol_type
      make_QUATE (const location_type& l)
      {
        return symbol_type (token::TOK_QUATE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
